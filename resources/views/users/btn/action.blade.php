...
<a href="javascript:;" class="btn btn-danger btn-icon mb-2" title="Delete" data-toggle="modal"
...
<a href="{{ route('user.edit', ['user' => $id]) }}" class="btn btn-md btn-success btn-icon mb-2"
    title="Edit details">
    <span class="svg-icon svg-icon-md">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="color-black" style="color:black">{{ __('Are you sure you want delete this item  ? ') }}</p>
            </div>
